# -*- coding: utf-8 -*-
"""Copy of Axis_final_summery.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/153wCIMgkKoq3VXFwPoLOL_PNbz7RkTpX
"""
...
df = pd.DataFrame(w)
df1 = df.rename(columns={df.columns[0]: 'Tran Date', df.columns[1]: 'Chq No', df.columns[2]: 'Particulars',
                df.columns[3]: 'Debit', df.columns[4]: 'Credit', df.columns[5]: 'Balance', df.columns[6]: 'Init. Br'})
df1 = df1.iloc[2:]
...
def general():
    #  row 1 =>
    Sum_of_credits = df1.groupby(df1['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    # print(Sum_of_credits)

    #  row =>
    Sum_of_debits = df1.groupby(df1['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    # print(Sum_of_debits)

    #     row4 =>Total Amount of Cash Deposits
    Total_amount_withdrawals = df1[df1["Particulars"].str.contains("ATM-CASH")]
    Total_no_withdrawals = Total_amount_withdrawals.groupby(
        Total_amount_withdrawals['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    Total_amount_withdrawals['Categories'] = 'Withdrawal'
    df1.update(Total_amount_withdrawals)

    #     row 3 =>Total Amount of Cash Withdrawals
    Total_amount_cash_depo = df1[df1["Particulars"].str.contains(
        "BY CASH DEPOSIT") | df1["Particulars"].str.contains("SAK")]
    Total_no_cash_depo = Total_amount_cash_depo.groupby(
        Total_amount_cash_depo['Tran Date'].dt.strftime('%b-%Y'))['Credit'].sum().sort_values()
    ...
    POS_cr = pos_df.groupby(pos_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    # print(POS_cr)
    POS_dr = pos_df.groupby(pos_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    ...
    Inv_dr = Inv_details.groupby(Inv_details['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    print(Inv_dr)
    ...
    #   Sum_of_credits
    try:
        sumr.cell(row=14, column=3,
                  value=Sum_of_credits[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=14, column=3, value=0)
    try:
        sumr.cell(row=14, column=4,
                  value=Sum_of_credits[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=14, column=4, value=0)
    try:
        sumr.cell(row=14, column=5,
                  value=Sum_of_credits[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=14, column=5, value=0)
    try:
        sumr.cell(row=14, column=6,
                  value=Sum_of_credits[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=14, column=6, value=0)
    try:
        sumr.cell(row=14, column=7,
                  value=Sum_of_credits[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=14, column=7, value=0)
    try:
        sumr.cell(row=14, column=8,
                  value=Sum_of_credits[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=14, column=8, value=0)
    try:
        sumr.cell(row=14, column=9,
                  value=Sum_of_credits[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=14, column=9, value=0)
    try:
        sumr.cell(row=14, column=10,
                  value=Sum_of_credits[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=14, column=10, value=0)
    try:
        sumr.cell(row=14, column=11,
                  value=Sum_of_credits[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=14, column=11, value=0)
    try:
        sumr.cell(row=14, column=12,
                  value=Sum_of_credits[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=14, column=12, value=0)
    try:
        sumr.cell(row=14, column=13,
                  value=Sum_of_credits[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=14, column=13, value=0)
    try:
        sumr.cell(row=14, column=14,
                  value=Sum_of_credits[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=14, column=14, value=0)

    #   Sum_of_credits
    try:
        sumr.cell(row=26, column=3,
                  value=Sum_of_credits[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=26, column=3, value=0)
    try:
        sumr.cell(row=26, column=4,
                  value=Sum_of_credits[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=26, column=4, value=0)
    try:
        sumr.cell(row=26, column=5,
                  value=Sum_of_credits[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=26, column=5, value=0)
    try:
        sumr.cell(row=26, column=6,
                  value=Sum_of_credits[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=26, column=6, value=0)
    try:
        sumr.cell(row=26, column=7,
                  value=Sum_of_credits[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=26, column=7, value=0)
    try:
        sumr.cell(row=26, column=8,
                  value=Sum_of_credits[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=26, column=8, value=0)
    try:
        sumr.cell(row=26, column=9,
                  value=Sum_of_credits[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=26, column=9, value=0)
    try:
        sumr.cell(row=26, column=10,
                  value=Sum_of_credits[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=26, column=10, value=0)
    try:
        sumr.cell(row=26, column=11,
                  value=Sum_of_credits[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=26, column=11, value=0)
    try:
        sumr.cell(row=26, column=12,
                  value=Sum_of_credits[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=26, column=12, value=0)
    try:
        sumr.cell(row=26, column=13,
                  value=Sum_of_credits[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=26, column=13, value=0)
    try:
        sumr.cell(row=26, column=14,
                  value=Sum_of_credits[sumr.cell(row=13, column=14).value])
    except Exception as e:
    ...
    #   Sum_of_debits
    try:
        sumr.cell(row=15, column=3,
                  value=Sum_of_debits[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=15, column=3, value=0)
    try:
        sumr.cell(row=15, column=4,
                  value=Sum_of_debits[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=15, column=4, value=0)
    try:
        sumr.cell(row=15, column=5,
                  value=Sum_of_debits[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=15, column=5, value=0)
    try:
        sumr.cell(row=15, column=6,
                  value=Sum_of_debits[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=15, column=6, value=0)
    try:
        sumr.cell(row=15, column=7,
                  value=Sum_of_debits[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=15, column=7, value=0)
    try:
        sumr.cell(row=15, column=8,
                  value=Sum_of_debits[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=15, column=8, value=0)
    try:
        sumr.cell(row=15, column=9,
                  value=Sum_of_debits[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=15, column=9, value=0)
    try:
        sumr.cell(row=15, column=10,
                  value=Sum_of_debits[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=15, column=10, value=0)
    try:
        sumr.cell(row=15, column=11,
                  value=Sum_of_debits[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=15, column=11, value=0)
    try:
        sumr.cell(row=15, column=12,
                  value=Sum_of_debits[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=15, column=12, value=0)
    try:
        sumr.cell(row=15, column=13,
                  value=Sum_of_debits[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=15, column=13, value=0)
    try:
        sumr.cell(row=15, column=14,
                  value=Sum_of_debits[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=15, column=14, value=0)

        #   Sum_of_debits
    try:
        sumr.cell(row=63, column=3,
                  value=Sum_of_debits[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=63, column=3, value=0)
    try:
        sumr.cell(row=63, column=4,
                  value=Sum_of_debits[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=63, column=4, value=0)
    try:
        sumr.cell(row=63, column=5,
                  value=Sum_of_debits[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=63, column=5, value=0)
    try:
        sumr.cell(row=63, column=6,
                  value=Sum_of_debits[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=63, column=6, value=0)
    try:
        sumr.cell(row=63, column=7,
                  value=Sum_of_debits[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=63, column=7, value=0)
    try:
        sumr.cell(row=63, column=8,
                  value=Sum_of_debits[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=63, column=8, value=0)
    try:
        sumr.cell(row=63, column=9,
                  value=Sum_of_debits[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=63, column=9, value=0)
    try:
        sumr.cell(row=63, column=10,
                  value=Sum_of_debits[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=63, column=10, value=0)
    try:
        sumr.cell(row=63, column=11,
                  value=Sum_of_debits[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=63, column=11, value=0)
    try:
        sumr.cell(row=63, column=12,
                  value=Sum_of_debits[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=63, column=12, value=0)
    try:
        sumr.cell(row=63, column=13,
                  value=Sum_of_debits[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=63, column=13, value=0)
    try:
        sumr.cell(row=63, column=14,
                  value=Sum_of_debits[sumr.cell(row=13, column=14).value])
    except Exception as e:
    ...
    try:
        sumr.cell(row=16, column=3,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=16, column=3, value=0)
    try:
        sumr.cell(row=16, column=4,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=16, column=4, value=0)
    try:
        sumr.cell(row=16, column=5,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=16, column=5, value=0)
    try:
        sumr.cell(row=16, column=6,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=16, column=6, value=0)
    try:
        sumr.cell(row=16, column=7,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=16, column=7, value=0)
    try:
        sumr.cell(row=16, column=8,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=16, column=8, value=0)
    try:
        sumr.cell(row=16, column=9,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=16, column=9, value=0)
    try:
        sumr.cell(row=16, column=10,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=16, column=10, value=0)
    try:
        sumr.cell(row=16, column=11,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=16, column=11, value=0)
    try:
        sumr.cell(row=16, column=12,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=16, column=12, value=0)
    try:
        sumr.cell(row=16, column=13,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=16, column=13, value=0)
    try:
        sumr.cell(row=16, column=14,
                  value=Total_no_withdrawals[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=16, column=14, value=0)

    # Total_no_cash_depo
    try:
        sumr.cell(row=17, column=3,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=17, column=3, value=0)
    try:
        sumr.cell(row=17, column=4,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=17, column=4, value=0)
    try:
        sumr.cell(row=17, column=5,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=17, column=5, value=0)
    try:
        sumr.cell(row=17, column=6,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=17, column=6, value=0)
    try:
        sumr.cell(row=17, column=7,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=17, column=7, value=0)
    try:
        sumr.cell(row=17, column=8,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=17, column=8, value=0)
    try:
        sumr.cell(row=17, column=9,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=17, column=9, value=0)
    try:
        sumr.cell(row=17, column=10,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=17, column=10, value=0)
    try:
        sumr.cell(row=17, column=11,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=17, column=11, value=0)
    try:
        sumr.cell(row=17, column=12,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=17, column=12, value=0)
    try:
        sumr.cell(row=17, column=13,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=17, column=13, value=0)
    try:
        sumr.cell(row=17, column=14,
                  value=Total_no_cash_depo[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=17, column=14, value=0)

    # POS_cr
    try:
        sumr.cell(row=18, column=3,
                  value=POS_cr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=18, column=3, value=0)
    try:
        sumr.cell(row=18, column=4,
                  value=POS_cr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=18, column=4, value=0)
    try:
        sumr.cell(row=18, column=5,
                  value=POS_cr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=18, column=5, value=0)
    try:
        sumr.cell(row=18, column=6,
                  value=POS_cr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=18, column=6, value=0)
    try:
        sumr.cell(row=18, column=7,
                  value=POS_cr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=18, column=7, value=0)
    try:
        sumr.cell(row=18, column=8,
                  value=POS_cr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=18, column=8, value=0)
    try:
        sumr.cell(row=18, column=9,
                  value=POS_cr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=18, column=9, value=0)
    try:
        sumr.cell(row=18, column=10,
                  value=POS_cr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=18, column=10, value=0)
    try:
        sumr.cell(row=18, column=11,
                  value=POS_cr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=18, column=11, value=0)
    try:
        sumr.cell(row=18, column=12,
                  value=POS_cr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=18, column=12, value=0)
    try:
        sumr.cell(row=18, column=13,
                  value=POS_cr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=18, column=13, value=0)
    try:
        sumr.cell(row=18, column=14,
                  value=POS_cr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=18, column=14, value=0)

    # POS_dr
    try:
        sumr.cell(row=20, column=3,
                  value=POS_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=20, column=3, value=0)
    try:
        sumr.cell(row=20, column=4,
                  value=POS_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=20, column=4, value=0)
    try:
        sumr.cell(row=20, column=5,
                  value=POS_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=20, column=5, value=0)
    try:
        sumr.cell(row=20, column=6,
                  value=POS_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=20, column=6, value=0)
    try:
        sumr.cell(row=20, column=7,
                  value=POS_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=20, column=7, value=0)
    try:
        sumr.cell(row=20, column=8,
                  value=POS_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=20, column=8, value=0)
    try:
        sumr.cell(row=20, column=9,
                  value=POS_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=20, column=9, value=0)
    try:
        sumr.cell(row=20, column=10,
                  value=POS_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=20, column=10, value=0)
    try:
        sumr.cell(row=20, column=11,
                  value=POS_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=20, column=11, value=0)
    try:
        sumr.cell(row=20, column=12,
                  value=POS_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=20, column=12, value=0)
    try:
        sumr.cell(row=20, column=13,
                  value=POS_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=20, column=13, value=0)
    try:
        sumr.cell(row=20, column=14,
                  value=POS_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=20, column=14, value=0)

    # POS_dr
    try:
        sumr.cell(row=19, column=3,
                  value=Inv_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=19, column=3, value=0)
    try:
        sumr.cell(row=19, column=4,
                  value=Inv_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=19, column=4, value=0)
    try:
        sumr.cell(row=19, column=5,
                  value=Inv_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=19, column=5, value=0)
    try:
        sumr.cell(row=19, column=6,
                  value=Inv_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=19, column=6, value=0)
    try:
        sumr.cell(row=19, column=7,
                  value=Inv_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=19, column=7, value=0)
    try:
        sumr.cell(row=19, column=8,
                  value=Inv_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=19, column=8, value=0)
    try:
        sumr.cell(row=19, column=9,
                  value=Inv_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=19, column=9, value=0)
    try:
        sumr.cell(row=19, column=10,
                  value=Inv_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=19, column=10, value=0)
    try:
        sumr.cell(row=19, column=11,
                  value=Inv_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=19, column=11, value=0)
    try:
        sumr.cell(row=19, column=12,
                  value=Inv_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=19, column=12, value=0)
    try:
        sumr.cell(row=19, column=13,
                  value=Inv_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=19, column=13, value=0)
    try:
        sumr.cell(row=19, column=14,
                  value=Inv_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
...
def Balance():
    ...
    sumr = wb['summary']
    eod = wb['EOD Balance']
    df5 = pd.read_excel('Excel_Files/Dashboard/BankStatement.xlsx',
                        sheet_name='EOD Balance', index_col='Day')
...
#     Intrest Credit
    ...
    Interest = df_grouped.groupby(df_grouped['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    ...
    #     Nach receaved
    Nach = df1[df1['Particulars'].str.contains(
        'ECS') | df1['Particulars'].str.contains('NACH-CR')]
    Nach_cr = Nach.groupby(Nach['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    Nach['Categories'] = 'NACH-CR'
    df1.update(Nach)

    IT_Nach = df1[df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2018-19-NACH', na=False) | df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2019-20-NACH', na=False) | df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2020-21-NACH', na=False) | df1['Particulars'].str.contains(
        'ACH-CR') & df1['Particulars'].str.contains('AY2021-22-NACH', na=False) | df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2022-23-NACH', na=False) | df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2023-24-NACH', na=False) | df1['Particulars'].str.contains('ACH-CR') & df1['Particulars'].str.contains('AY2024-25-NACH', na=False)]
    IT_Nach_rec = IT_Nach.groupby(IT_Nach['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    ...
    rent_cr = rent_df.groupby(rent_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    # print(rent_cr)
    ...
    salary = df_salary.groupby(df_salary['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
  ...
  #   Dividend
    ...
    dividend = dividend_df.groupby(dividend_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    ...
    loan = loan_df.groupby(loan_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Credit'].sum().sort_values()
    loan['Categories'] = 'loan'
    df1.update(loan)

    try:
        sumr.cell(row=27, column=3,
                  value=Interest[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=27, column=3, value=0)
    try:
        sumr.cell(row=27, column=4,
                  value=Interest[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=27, column=4, value=0)
    try:
        sumr.cell(row=27, column=5,
                  value=Interest[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=27, column=5, value=0)
    try:
        sumr.cell(row=27, column=6,
                  value=Interest[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=27, column=6, value=0)
    try:
        sumr.cell(row=27, column=7,
                  value=Interest[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=27, column=7, value=0)
    try:
        sumr.cell(row=27, column=8,
                  value=Interest[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=27, column=8, value=0)
    try:
        sumr.cell(row=27, column=9,
                  value=Interest[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=27, column=9, value=0)
    try:
        sumr.cell(row=27, column=10,
                  value=Interest[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=27, column=10, value=0)
    try:
        sumr.cell(row=27, column=11,
                  value=Interest[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=27, column=11, value=0)
    try:
        sumr.cell(row=27, column=12,
                  value=Interest[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=27, column=12, value=0)
    try:
        sumr.cell(row=27, column=13,
                  value=Interest[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=27, column=13, value=0)
    try:
        sumr.cell(row=27, column=14,
                  value=Interest[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=27, column=14, value=0)

    try:
        sumr.cell(row=28, column=3,
                  value=salary[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=28, column=3, value=0)
    try:
        sumr.cell(row=28, column=4,
                  value=salary[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=28, column=4, value=0)
    try:
        sumr.cell(row=28, column=5,
                  value=salary[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=28, column=5, value=0)
    try:
        sumr.cell(row=28, column=6,
                  value=salary[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=28, column=6, value=0)
    try:
        sumr.cell(row=28, column=7,
                  value=salary[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=28, column=7, value=0)
    try:
        sumr.cell(row=28, column=8,
                  value=salary[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=28, column=8, value=0)
    try:
        sumr.cell(row=28, column=9,
                  value=salary[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=28, column=9, value=0)
    try:
        sumr.cell(row=28, column=10,
                  value=salary[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=28, column=10, value=0)
    try:
        sumr.cell(row=28, column=11,
                  value=salary[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=28, column=11, value=0)
    try:
        sumr.cell(row=28, column=12,
                  value=salary[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=28, column=12, value=0)
    try:
        sumr.cell(row=28, column=13,
                  value=salary[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=28, column=13, value=0)
    try:
        sumr.cell(row=28, column=14,
                  value=salary[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=28, column=14, value=0)

    try:
        sumr.cell(row=29, column=3,
                  value=Nach_cr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=29, column=3, value=0)
    try:
        sumr.cell(row=29, column=4,
                  value=Nach_cr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=29, column=4, value=0)
    try:
        sumr.cell(row=29, column=5,
                  value=Nach_cr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=29, column=5, value=0)
    try:
        sumr.cell(row=29, column=6,
                  value=Nach_cr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=29, column=6, value=0)
    try:
        sumr.cell(row=29, column=7,
                  value=Nach_cr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=29, column=7, value=0)
    try:
        sumr.cell(row=29, column=8,
                  value=Nach_cr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=29, column=8, value=0)
    try:
        sumr.cell(row=29, column=9,
                  value=Nach_cr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=29, column=9, value=0)
    try:
        sumr.cell(row=29, column=10,
                  value=Nach_cr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=29, column=10, value=0)
    try:
        sumr.cell(row=29, column=11,
                  value=Nach_cr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=29, column=11, value=0)
    try:
        sumr.cell(row=29, column=12,
                  value=Nach_cr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=29, column=12, value=0)
    try:
        sumr.cell(row=29, column=13,
                  value=Nach_cr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=29, column=13, value=0)
    try:
        sumr.cell(row=29, column=14,
                  value=Nach_cr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=29, column=14, value=0)

    try:
        sumr.cell(row=30, column=3,
                  value=loan[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=30, column=3, value=0)
    try:
        sumr.cell(row=30, column=4,
                  value=loan[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=30, column=4, value=0)
    try:
        sumr.cell(row=30, column=5,
                  value=loan[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=30, column=5, value=0)
    try:
        sumr.cell(row=30, column=6,
                  value=loan[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=30, column=6, value=0)
    try:
        sumr.cell(row=30, column=7,
                  value=loan[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=30, column=7, value=0)
    try:
        sumr.cell(row=30, column=8,
                  value=loan[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=30, column=8, value=0)
    try:
        sumr.cell(row=30, column=9,
                  value=loan[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=30, column=9, value=0)
    try:
        sumr.cell(row=30, column=10,
                  value=loan[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=30, column=10, value=0)
    try:
        sumr.cell(row=30, column=11,
                  value=loan[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=30, column=11, value=0)
    try:
        sumr.cell(row=30, column=12,
                  value=loan[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=30, column=12, value=0)
    try:
        sumr.cell(row=30, column=13,
                  value=loan[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=30, column=13, value=0)
    try:
        sumr.cell(row=30, column=14,
                  value=loan[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=30, column=14, value=0)

    try:
        sumr.cell(row=31, column=3,
                  value=IT_Nach_rec[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=31, column=3, value=0)
    try:
        sumr.cell(row=31, column=4,
                  value=IT_Nach_rec[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=31, column=4, value=0)
    try:
        sumr.cell(row=31, column=5,
                  value=IT_Nach_rec[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=31, column=5, value=0)
    try:
        sumr.cell(row=31, column=6,
                  value=IT_Nach_rec[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=31, column=6, value=0)
    try:
        sumr.cell(row=31, column=7,
                  value=IT_Nach_rec[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=31, column=7, value=0)
    try:
        sumr.cell(row=31, column=8,
                  value=IT_Nach_rec[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=31, column=8, value=0)
    try:
        sumr.cell(row=31, column=9,
                  value=IT_Nach_rec[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=31, column=9, value=0)
    try:
        sumr.cell(row=31, column=10,
                  value=IT_Nach_rec[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=31, column=10, value=0)
    try:
        sumr.cell(row=31, column=11,
                  value=IT_Nach_rec[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=31, column=11, value=0)
    try:
        sumr.cell(row=31, column=12,
                  value=IT_Nach_rec[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=31, column=12, value=0)
    try:
        sumr.cell(row=31, column=13,
                  value=IT_Nach_rec[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=31, column=13, value=0)
    try:
        sumr.cell(row=31, column=14,
                  value=IT_Nach_rec[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=31, column=14, value=0)

    try:
        sumr.cell(row=32, column=3,
                  value=dividend[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=32, column=3, value=0)
    try:
        sumr.cell(row=32, column=4,
                  value=dividend[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=32, column=4, value=0)
    try:
        sumr.cell(row=32, column=5,
                  value=dividend[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=32, column=5, value=0)
    try:
        sumr.cell(row=32, column=6,
                  value=dividend[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=32, column=6, value=0)
    try:
        sumr.cell(row=32, column=7,
                  value=dividend[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=32, column=7, value=0)
    try:
        sumr.cell(row=32, column=8,
                  value=dividend[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=32, column=8, value=0)
    try:
        sumr.cell(row=32, column=9,
                  value=dividend[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=32, column=9, value=0)
    try:
        sumr.cell(row=32, column=10,
                  value=dividend[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=32, column=10, value=0)
    try:
        sumr.cell(row=32, column=11,
                  value=dividend[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=32, column=11, value=0)
    try:
        sumr.cell(row=32, column=12,
                  value=dividend[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=32, column=12, value=0)
    try:
        sumr.cell(row=32, column=13,
                  value=dividend[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=32, column=13, value=0)
    try:
        sumr.cell(row=32, column=14,
                  value=dividend[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=32, column=14, value=0)

    try:
        sumr.cell(row=33, column=3,
                  value=rent_cr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=33, column=3, value=0)
    try:
        sumr.cell(row=33, column=4,
                  value=rent_cr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=33, column=4, value=0)
    try:
        sumr.cell(row=33, column=5,
                  value=rent_cr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=33, column=5, value=0)
    try:
        sumr.cell(row=33, column=6,
                  value=rent_cr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=33, column=6, value=0)
    try:
        sumr.cell(row=33, column=7,
                  value=rent_cr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=33, column=7, value=0)
    try:
        sumr.cell(row=33, column=8,
                  value=rent_cr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=33, column=8, value=0)
    try:
        sumr.cell(row=33, column=9,
                  value=rent_cr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=33, column=9, value=0)
    try:
        sumr.cell(row=33, column=10,
                  value=rent_cr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=33, column=10, value=0)
    try:
        sumr.cell(row=33, column=11,
                  value=rent_cr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=33, column=11, value=0)
    try:
        sumr.cell(row=33, column=12,
                  value=rent_cr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=33, column=12, value=0)
    try:
        sumr.cell(row=32, column=13,
                  value=rent_cr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=33, column=13, value=0)
    try:
        sumr.cell(row=33, column=14,
                  value=rent_cr[sumr.cell(row=13, column=14).value])
    except Exception as e:
...
#     print(Sum_of_debits)
    ...
    Interest_paid = df_interest.groupby(
        df_interest['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    # print(df_interest)
    ...
    # Bank charges
    df_charges = df1[df1["Particulars"].str.contains(
        "Consolidated Charges for A/c") | df1["Particulars"].str.contains("Dr Card Charges ANNUAL")]
    Bank_charges = df_charges.groupby(
        df_charges['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    df_charges['Categories'] = 'Bank charges'
    df1.update(df_charges)
    # print(df_charges)

    # Emi
    new_emi = df1[df1['Particulars'].str.contains(
        'ECS') | df1['Particulars'].str.contains('NACH')]
    Emi_dr = new_emi.groupby(new_emi['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    ...
    gst = df_gst.groupby(df_gst['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    ...
    # Traveling bills
    Traveling_expence_df = df1[df1["Particulars"].str.contains("Ola") | df1['Particulars'].str.contains(
        'Uber') | df1['Particulars'].str.contains('Irctc') | df1['Particulars'].str.contains('Indian Railways')]
    TravelingExpence = Traveling_expence_df.groupby(
        Traveling_expence_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    # print(TravelingExpence)
    Traveling_expence_df['Categories'] = 'Traveling bills'
    df1.update(Traveling_expence_df)

    rent_df = df1[df1['Particulars'].str.contains(
        'RENT') | df1['Particulars'].str.contains('Rent')]
    rent_dr = rent_df.groupby(rent_df['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    RENT1 = df1[df1["Particulars"].str.contains(
        "RENT") | df1['Particulars'].str.contains('Rent')].groupby('Debit')
    ...
    tds = TDS.groupby(TDS['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()

    # Total income tax paid
    TAX = df1[df1["Particulars"].str.contains("tax", na=False)]
    tax = TAX.groupby(TAX['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()

    try:
        sumr.cell(row=39, column=3,
                  value=salary[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=39, column=3, value=0)
    try:
        sumr.cell(row=39, column=4,
                  value=salary[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=39, column=4, value=0)
    try:
        sumr.cell(row=39, column=5,
                  value=salary[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=39, column=5, value=0)
    try:
        sumr.cell(row=39, column=6,
                  value=salary[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=39, column=6, value=0)
    try:
        sumr.cell(row=39, column=7,
                  value=salary[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=39, column=7, value=0)
    try:
        sumr.cell(row=39, column=8,
                  value=salary[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=39, column=8, value=0)
    try:
        sumr.cell(row=39, column=9,
                  value=salary[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=39, column=9, value=0)
    try:
        sumr.cell(row=39, column=10,
                  value=salary[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=39, column=10, value=0)
    try:
        sumr.cell(row=39, column=11,
                  value=salary[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=39, column=11, value=0)
    try:
        sumr.cell(row=39, column=12,
                  value=salary[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=39, column=12, value=0)
    try:
        sumr.cell(row=39, column=13,
                  value=salary[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=39, column=13, value=0)
    try:
        sumr.cell(row=39, column=14,
                  value=salary[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=39, column=14, value=0)

    try:
        sumr.cell(row=37, column=3,
                  value=Sum_of_debits[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=37, column=3, value=0)
    try:
        sumr.cell(row=37, column=4,
                  value=Sum_of_debits[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=37, column=4, value=0)
    try:
        sumr.cell(row=37, column=5,
                  value=Sum_of_debits[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=37, column=5, value=0)
    try:
        sumr.cell(row=37, column=6,
                  value=Sum_of_debits[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=37, column=6, value=0)
    try:
        sumr.cell(row=37, column=7,
                  value=Sum_of_debits[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=37, column=7, value=0)
    try:
        sumr.cell(row=37, column=8,
                  value=Sum_of_debits[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=37, column=8, value=0)
    try:
        sumr.cell(row=37, column=9,
                  value=Sum_of_debits[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=37, column=9, value=0)
    try:
        sumr.cell(row=37, column=10,
                  value=Sum_of_debits[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=37, column=10, value=0)
    try:
        sumr.cell(row=37, column=11,
                  value=Sum_of_debits[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=37, column=11, value=0)
    try:
        sumr.cell(row=37, column=12,
                  value=Sum_of_debits[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=37, column=12, value=0)
    try:
        sumr.cell(row=37, column=13,
                  value=Sum_of_debits[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=37, column=13, value=0)
    try:
        sumr.cell(row=37, column=14,
                  value=Sum_of_debits[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=37, column=14, value=0)

    try:
        sumr.cell(row=42, column=3,
                  value=tds[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=42, column=3, value=0)
    try:
        sumr.cell(row=42, column=4,
                  value=tds[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=42, column=4, value=0)
    try:
        sumr.cell(row=42, column=5,
                  value=tds[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=42, column=5, value=0)
    try:
        sumr.cell(row=42, column=6,
                  value=tds[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=42, column=6, value=0)
    try:
        sumr.cell(row=42, column=7,
                  value=tds[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=42, column=7, value=0)
    try:
        sumr.cell(row=42, column=8,
                  value=tds[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=42, column=8, value=0)
    try:
        sumr.cell(row=42, column=9,
                  value=tds[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=42, column=9, value=0)
    try:
        sumr.cell(row=42, column=10,
                  value=tds[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=42, column=10, value=0)
    try:
        sumr.cell(row=42, column=11,
                  value=tds[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=42, column=11, value=0)
    try:
        sumr.cell(row=42, column=12,
                  value=tds[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=42, column=12, value=0)
    try:
        sumr.cell(row=42, column=13,
                  value=tds[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=42, column=13, value=0)
    try:
        sumr.cell(row=42, column=14,
                  value=tds[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=42, column=14, value=0)

    try:
        sumr.cell(row=68, column=3,
                  value=tds[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=68, column=3, value=0)
    try:
        sumr.cell(row=68, column=4,
                  value=tds[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=68, column=4, value=0)
    try:
        sumr.cell(row=68, column=5,
                  value=tds[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=68, column=5, value=0)
    try:
        sumr.cell(row=68, column=6,
                  value=tds[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=68, column=6, value=0)
    try:
        sumr.cell(row=68, column=7,
                  value=tds[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=68, column=7, value=0)
    try:
        sumr.cell(row=68, column=8,
                  value=tds[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=68, column=8, value=0)
    try:
        sumr.cell(row=68, column=9,
                  value=tds[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=68, column=9, value=0)
    try:
        sumr.cell(row=68, column=10,
                  value=tds[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=68, column=10, value=0)
    try:
        sumr.cell(row=68, column=11,
                  value=tds[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=68, column=11, value=0)
    try:
        sumr.cell(row=68, column=12,
                  value=tds[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=68, column=12, value=0)
    try:
        sumr.cell(row=68, column=13,
                  value=tds[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=68, column=13, value=0)
    try:
        sumr.cell(row=68, column=14,
                  value=tds[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=68, column=14, value=0)

    try:
        sumr.cell(row=44, column=3,
                  value=tax[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=44, column=3, value=0)
    try:
        sumr.cell(row=44, column=4,
                  value=tax[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=44, column=4, value=0)
    try:
        sumr.cell(row=44, column=5,
                  value=tax[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=44, column=5, value=0)
    try:
        sumr.cell(row=44, column=6,
                  value=tax[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=44, column=6, value=0)
    try:
        sumr.cell(row=44, column=7,
                  value=tax[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=44, column=7, value=0)
    try:
        sumr.cell(row=44, column=8,
                  value=tax[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=44, column=8, value=0)
    try:
        sumr.cell(row=44, column=9,
                  value=tax[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=44, column=9, value=0)
    try:
        sumr.cell(row=44, column=10,
                  value=tax[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=44, column=10, value=0)
    try:
        sumr.cell(row=44, column=11,
                  value=tax[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=44, column=11, value=0)
    try:
        sumr.cell(row=44, column=12,
                  value=tax[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=44, column=12, value=0)
    try:
        sumr.cell(row=44, column=13,
                  value=tax[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=44, column=13, value=0)
    try:
        sumr.cell(row=44, column=14,
                  value=tax[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=44, column=14, value=0)

    try:
        sumr.cell(row=46, column=3,
                  value=TravelingExpence[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=46, column=3, value=0)
    try:
        sumr.cell(row=46, column=4,
                  value=TravelingExpence[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=46, column=4, value=0)
    try:
        sumr.cell(row=46, column=5,
                  value=TravelingExpence[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=46, column=5, value=0)
    try:
        sumr.cell(row=46, column=6,
                  value=TravelingExpence[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=46, column=6, value=0)
    try:
        sumr.cell(row=46, column=7,
                  value=TravelingExpence[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=46, column=7, value=0)
    try:
        sumr.cell(row=46, column=8,
                  value=TravelingExpence[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=46, column=8, value=0)
    try:
        sumr.cell(row=46, column=9,
                  value=TravelingExpence[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=46, column=9, value=0)
    try:
        sumr.cell(row=46, column=10,
                  value=TravelingExpence[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=46, column=10, value=0)
    try:
        sumr.cell(row=46, column=11,
                  value=TravelingExpence[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=46, column=11, value=0)
    try:
        sumr.cell(row=46, column=12,
                  value=TravelingExpence[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=46, column=12, value=0)
    try:
        sumr.cell(row=46, column=13,
                  value=TravelingExpence[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=46, column=13, value=0)
    try:
        sumr.cell(row=46, column=14,
                  value=TravelingExpence[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=46, column=14, value=0)

    try:
        sumr.cell(row=72, column=3,
                  value=TravelingExpence[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=72, column=3, value=0)
    try:
        sumr.cell(row=72, column=4,
                  value=TravelingExpence[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=72, column=4, value=0)
    try:
        sumr.cell(row=72, column=5,
                  value=TravelingExpence[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=72, column=5, value=0)
    try:
        sumr.cell(row=72, column=6,
                  value=TravelingExpence[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=72, column=6, value=0)
    try:
        sumr.cell(row=72, column=7,
                  value=TravelingExpence[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=72, column=7, value=0)
    try:
        sumr.cell(row=72, column=8,
                  value=TravelingExpence[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=72, column=8, value=0)
    try:
        sumr.cell(row=72, column=9,
                  value=TravelingExpence[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=72, column=9, value=0)
    try:
        sumr.cell(row=72, column=10,
                  value=TravelingExpence[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=72, column=10, value=0)
    try:
        sumr.cell(row=72, column=11,
                  value=TravelingExpence[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=72, column=11, value=0)
    try:
        sumr.cell(row=72, column=12,
                  value=TravelingExpence[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=72, column=12, value=0)
    try:
        sumr.cell(row=72, column=13,
                  value=TravelingExpence[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=72, column=13, value=0)
    try:
        sumr.cell(row=72, column=14,
                  value=TravelingExpence[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=72, column=14, value=0)

    try:
        sumr.cell(row=38, column=3,
                  value=Interest_paid[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=38, column=3, value=0)
    try:
        sumr.cell(row=38, column=4,
                  value=Interest_paid[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=38, column=4, value=0)
    try:
        sumr.cell(row=38, column=5,
                  value=Interest_paid[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=38, column=5, value=0)
    try:
        sumr.cell(row=38, column=6,
                  value=Interest_paid[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=38, column=6, value=0)
    try:
        sumr.cell(row=38, column=7,
                  value=Interest_paid[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=38, column=7, value=0)
    try:
        sumr.cell(row=38, column=8,
                  value=Interest_paid[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=38, column=8, value=0)
    try:
        sumr.cell(row=38, column=9,
                  value=Interest_paid[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=38, column=9, value=0)
    try:
        sumr.cell(row=38, column=10,
                  value=Interest_paid[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=38, column=10, value=0)
    try:
        sumr.cell(row=38, column=11,
                  value=Interest_paid[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=38, column=11, value=0)
    try:
        sumr.cell(row=38, column=12,
                  value=Interest_paid[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=38, column=12, value=0)
    try:
        sumr.cell(row=38, column=13,
                  value=Interest_paid[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=38, column=13, value=0)
    try:
        sumr.cell(row=38, column=14,
                  value=Interest_paid[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=38, column=14, value=0)

    try:
        sumr.cell(row=40, column=3,
                  value=Bank_charges[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=40, column=3, value=0)
    try:
        sumr.cell(row=40, column=4,
                  value=Bank_charges[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=40, column=4, value=0)
    try:
        sumr.cell(row=40, column=5,
                  value=Bank_charges[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=40, column=5, value=0)
    try:
        sumr.cell(row=40, column=6,
                  value=Bank_charges[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=40, column=6, value=0)
    try:
        sumr.cell(row=40, column=7,
                  value=Bank_charges[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=40, column=7, value=0)
    try:
        sumr.cell(row=40, column=8,
                  value=Bank_charges[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=40, column=8, value=0)
    try:
        sumr.cell(row=40, column=9,
                  value=Bank_charges[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=40, column=9, value=0)
    try:
        sumr.cell(row=40, column=10,
                  value=Bank_charges[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=40, column=10, value=0)
    try:
        sumr.cell(row=40, column=11,
                  value=Bank_charges[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=40, column=11, value=0)
    try:
        sumr.cell(row=40, column=12,
                  value=Bank_charges[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=40, column=12, value=0)
    try:
        sumr.cell(row=40, column=13,
                  value=Bank_charges[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=40, column=13, value=0)
    try:
        sumr.cell(row=40, column=14,
                  value=Bank_charges[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=40, column=14, value=0)

    try:
        sumr.cell(row=41, column=3,
                  value=Emi_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=41, column=3, value=0)
    try:
        sumr.cell(row=41, column=4,
                  value=Emi_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=41, column=4, value=0)
    try:
        sumr.cell(row=41, column=5,
                  value=Emi_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=41, column=5, value=0)
    try:
        sumr.cell(row=41, column=6,
                  value=Emi_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=41, column=6, value=0)
    try:
        sumr.cell(row=41, column=7,
                  value=Emi_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=41, column=7, value=0)
    try:
        sumr.cell(row=41, column=8,
                  value=Emi_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=41, column=8, value=0)
    try:
        sumr.cell(row=41, column=9,
                  value=Emi_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=41, column=9, value=0)
    try:
        sumr.cell(row=41, column=10,
                  value=Emi_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=41, column=10, value=0)
    try:
        sumr.cell(row=41, column=11,
                  value=Emi_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=41, column=11, value=0)
    try:
        sumr.cell(row=41, column=12,
                  value=Emi_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=41, column=12, value=0)
    try:
        sumr.cell(row=41, column=13,
                  value=Emi_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=41, column=13, value=0)
    try:
        sumr.cell(row=41, column=14,
                  value=Emi_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=41, column=14, value=0)

    try:
        sumr.cell(row=43, column=3,
                  value=gst[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=43, column=3, value=0)
    try:
        sumr.cell(row=43, column=4,
                  value=gst[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=43, column=4, value=0)
    try:
        sumr.cell(row=43, column=5,
                  value=gst[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=43, column=5, value=0)
    try:
        sumr.cell(row=43, column=6,
                  value=gst[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=43, column=6, value=0)
    try:
        sumr.cell(row=43, column=7,
                  value=gst[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=43, column=7, value=0)
    try:
        sumr.cell(row=43, column=8,
                  value=gst[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=43, column=8, value=0)
    try:
        sumr.cell(row=43, column=9,
                  value=gst[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=43, column=9, value=0)
    try:
        sumr.cell(row=43, column=10,
                  value=gst[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=43, column=10, value=0)
    try:
        sumr.cell(row=43, column=11,
                  value=gst[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=43, column=11, value=0)
    try:
        sumr.cell(row=43, column=12,
                  value=gst[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=43, column=12, value=0)
    try:
        sumr.cell(row=43, column=13,
                  value=gst[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=43, column=13, value=0)
    try:
        sumr.cell(row=43, column=14,
                  value=gst[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=43, column=14, value=0)

    try:
        sumr.cell(row=47, column=3,
                  value=rent_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=47, column=3, value=0)
    try:
        sumr.cell(row=47, column=4,
                  value=rent_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=47, column=4, value=0)
    try:
        sumr.cell(row=47, column=5,
                  value=rent_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=47, column=5, value=0)
    try:
        sumr.cell(row=47, column=6,
                  value=rent_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=47, column=6, value=0)
    try:
        sumr.cell(row=47, column=7,
                  value=rent_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=47, column=7, value=0)
    try:
        sumr.cell(row=47, column=8,
                  value=rent_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=47, column=8, value=0)
    try:
        sumr.cell(row=47, column=9,
                  value=rent_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=47, column=9, value=0)
    try:
        sumr.cell(row=47, column=10,
                  value=rent_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=47, column=10, value=0)
    try:
        sumr.cell(row=47, column=11,
                  value=rent_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=47, column=11, value=0)
    try:
        sumr.cell(row=47, column=12,
                  value=rent_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=47, column=12, value=0)
    try:
        sumr.cell(row=47, column=13,
                  value=rent_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=47, column=13, value=0)
    try:
        sumr.cell(row=47, column=14,
                  value=rent_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
...
def PersonalExpenses():
    ...
    GeneralInsurance = General_insurance_df.groupby(
        General_insurance_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    General_insurance_df['Categories'] = 'General insurance'
    df1.update(General_insurance_df)

    Life_insuranc_df = df1[df1['Particulars'].str.contains('Life Insurance Corporation of India') | df1['Particulars'].str.contains('HDFC Standard Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Max Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('ICICI Prudential Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Kotak Mahindra Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Aditya Birla Sun Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('TATA AIA Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('SBI Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Exide Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Bajaj Allianz Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('PNB MetLife India Insurance Co. Ltd.') | df1['Particulars'].str.contains('Reliance Nippon Life Insurance Company') | df1['Particulars'].str.contains(
        'Aviva Life Insurance Company India Ltd.') | df1['Particulars'].str.contains('Sahara India Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Shriram Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Bharti AXA Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Future Generali India Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('IDBI Federal Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Canara HSBC Oriental Bank of Commerce Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Aegon Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Pramerica Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Star Union Dai-Ichi Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('IndiaFirst Life Insurance Co. Ltd.') | df1['Particulars'].str.contains('Edelweiss Tokio Life Insurance Co. Ltd.')]
    LifeInsurance = Life_insuranc_df.groupby(
        Life_insuranc_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    Life_insuranc_df['Categories'] = 'Life insurance'
    df1.update(Life_insuranc_df)

    Credit_card_df = df1[df1['Particulars'].str.contains(
        'Credit Card Payment')]
    CreditCharges = Credit_card_df.groupby(
        Credit_card_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    #  print(CreditCharges)
    Credit_card_df['Categories'] = 'Credit card'
    df1.update(Credit_card_df)

    Food_Expenxe_df = df1[df1['Particulars'].str.contains('Zomato') | df1['Particulars'].str.contains(
        'Swiggy') | df1['Particulars'].str.contains('Pizza') | df1['Particulars'].str.contains('Dominos')]
    FoodExpence = Food_Expenxe_df.groupby(
        Food_Expenxe_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    #  print(FoodExpence)
    Food_Expenxe_df['Categories'] = 'Food Expence'
    df1.update(Food_Expenxe_df)

    online_shopping_df = df1[df1['Particulars'].str.contains(
        'AMAZON -Dr') | df1['Particulars'].str.contains('Flipkart') | df1['Particulars'].str.contains('FLIPKART')]
    OnlineShopping = online_shopping_df.groupby(
        online_shopping_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
  # print(OnlineShopping)
    online_shopping_df['Categories'] = 'Online shopping'
    df1.update(online_shopping_df)

    gas_payments_df = df1[df1['Particulars'].str.contains('Oil and Natural Gas Corporation') | df1['Particulars'].str.contains('Indian Oil Corporation Limited') | df1['Particulars'].str.contains('Bharat Petroleum') | df1['Particulars'].str.contains('Gas Authority of India') | df1['Particulars'].str.contains(
        'Reliance Petroleum Ltd') | df1['Particulars'].str.contains('Hindustan Petroleum') | df1['Particulars'].str.contains('Oil India') | df1['Particulars'].str.contains('Cairn India') | df1['Particulars'].str.contains('TATA Petrodyne Ltd') | df1['Particulars'].str.contains('Essar Oil')]
    GasPayment = gas_payments_df.groupby(
        gas_payments_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
  # print(GasPayment)
    gas_payments_df['Categories'] = 'gas Payments'
    df1.update(gas_payments_df)

    Gold_loan_df = df1[df1['Particulars'].str.contains(
        'MUTHOOTFINCORP') | df1['Particulars'].str.contains('RUPEEKCAPITAL')]
    GoldLoan = Gold_loan_df.groupby(
        Gold_loan_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
  # print(GoldLoan)
    ...
    pt = Property_Tax.groupby(Property_Tax['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()

    try:
        sumr.cell(row=51, column=3,
                  value=GeneralInsurance[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=51, column=3, value=0)
    try:
        sumr.cell(row=51, column=4,
                  value=GeneralInsurance[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=51, column=4, value=0)
    try:
        sumr.cell(row=51, column=5,
                  value=GeneralInsurance[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=51, column=5, value=0)
    try:
        sumr.cell(row=51, column=6,
                  value=GeneralInsurance[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=51, column=6, value=0)
    try:
        sumr.cell(row=51, column=7,
                  value=GeneralInsurance[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=51, column=7, value=0)
    try:
        sumr.cell(row=51, column=8,
                  value=GeneralInsurance[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=51, column=8, value=0)
    try:
        sumr.cell(row=51, column=9,
                  value=GeneralInsurance[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=51, column=9, value=0)
    try:
        sumr.cell(row=51, column=10,
                  value=GeneralInsurance[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=51, column=10, value=0)
    try:
        sumr.cell(row=51, column=11,
                  value=GeneralInsurance[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=51, column=11, value=0)
    try:
        sumr.cell(row=51, column=12,
                  value=GeneralInsurance[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=51, column=12, value=0)
    try:
        sumr.cell(row=51, column=13,
                  value=GeneralInsurance[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=51, column=13, value=0)
    try:
        sumr.cell(row=51, column=14,
                  value=GeneralInsurance[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=51, column=14, value=0)

    try:
        sumr.cell(row=76, column=3,
                  value=GeneralInsurance[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=76, column=3, value=0)
    try:
        sumr.cell(row=76, column=4,
                  value=GeneralInsurance[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=76, column=4, value=0)
    try:
        sumr.cell(row=76, column=5,
                  value=GeneralInsurance[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=76, column=5, value=0)
    try:
        sumr.cell(row=76, column=6,
                  value=GeneralInsurance[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=76, column=6, value=0)
    try:
        sumr.cell(row=76, column=7,
                  value=GeneralInsurance[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=76, column=7, value=0)
    try:
        sumr.cell(row=76, column=8,
                  value=GeneralInsurance[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=76, column=8, value=0)
    try:
        sumr.cell(row=76, column=9,
                  value=GeneralInsurance[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=76, column=9, value=0)
    try:
        sumr.cell(row=76, column=10,
                  value=GeneralInsurance[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=76, column=10, value=0)
    try:
        sumr.cell(row=76, column=11,
                  value=GeneralInsurance[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=76, column=11, value=0)
    try:
        sumr.cell(row=76, column=12,
                  value=GeneralInsurance[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=76, column=12, value=0)
    try:
        sumr.cell(row=76, column=13,
                  value=GeneralInsurance[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=76, column=13, value=0)
    try:
        sumr.cell(row=76, column=14,
                  value=GeneralInsurance[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=76, column=14, value=0)

    try:
        sumr.cell(row=52, column=3,
                  value=LifeInsurance[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=52, column=3, value=0)
    try:
        sumr.cell(row=52, column=4,
                  value=LifeInsurance[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=52, column=4, value=0)
    try:
        sumr.cell(row=52, column=5,
                  value=LifeInsurance[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=52, column=5, value=0)
    try:
        sumr.cell(row=52, column=6,
                  value=LifeInsurance[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=52, column=6, value=0)
    try:
        sumr.cell(row=52, column=7,
                  value=LifeInsurance[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=52, column=7, value=0)
    try:
        sumr.cell(row=52, column=8,
                  value=LifeInsurance[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=52, column=8, value=0)
    try:
        sumr.cell(row=52, column=9,
                  value=LifeInsurance[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=52, column=9, value=0)
    try:
        sumr.cell(row=52, column=10,
                  value=LifeInsurance[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=52, column=10, value=0)
    try:
        sumr.cell(row=52, column=11,
                  value=LifeInsurance[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=52, column=11, value=0)
    try:
        sumr.cell(row=52, column=12,
                  value=LifeInsurance[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=52, column=12, value=0)
    try:
        sumr.cell(row=52, column=13,
                  value=LifeInsurance[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=52, column=13, value=0)
    try:
        sumr.cell(row=52, column=14,
                  value=LifeInsurance[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=52, column=14, value=0)

        try:
            sumr.cell(row=56, column=3,
                      value=pt[sumr.cell(row=13, column=3).value])
        except Exception as e:
            sumr.cell(row=56, column=3, value=0)
        try:
            sumr.cell(row=56, column=4,
                      value=pt[sumr.cell(row=13, column=4).value])
        except Exception as e:
            sumr.cell(row=56, column=4, value=0)
        try:
            sumr.cell(row=56, column=5,
                      value=pt[sumr.cell(row=13, column=5).value])
        except Exception as e:
            sumr.cell(row=56, column=5, value=0)
        try:
            sumr.cell(row=56, column=6,
                      value=pt[sumr.cell(row=13, column=6).value])
        except Exception as e:
            sumr.cell(row=56, column=6, value=0)
        try:
            sumr.cell(row=56, column=7,
                      value=pt[sumr.cell(row=13, column=7).value])
        except Exception as e:
            sumr.cell(row=56, column=7, value=0)
        try:
            sumr.cell(row=56, column=8,
                      value=pt[sumr.cell(row=13, column=8).value])
        except Exception as e:
            sumr.cell(row=56, column=8, value=0)
        try:
            sumr.cell(row=56, column=9,
                      value=pt[sumr.cell(row=13, column=9).value])
        except Exception as e:
            sumr.cell(row=56, column=9, value=0)
        try:
            sumr.cell(row=56, column=10,
                      value=pt[sumr.cell(row=13, column=10).value])
        except Exception as e:
            sumr.cell(row=56, column=10, value=0)
        try:
            sumr.cell(row=56, column=11,
                      value=pt[sumr.cell(row=13, column=11).value])
        except Exception as e:
            sumr.cell(row=56, column=11, value=0)
        try:
            sumr.cell(row=56, column=12,
                      value=pt[sumr.cell(row=13, column=12).value])
        except Exception as e:
            sumr.cell(row=56, column=12, value=0)
        try:
            sumr.cell(row=56, column=13,
                      value=pt[sumr.cell(row=13, column=13).value])
        except Exception as e:
            sumr.cell(row=56, column=13, value=0)
        try:
            sumr.cell(row=56, column=14,
                      value=pt[sumr.cell(row=13, column=14).value])
        except Exception as e:
            sumr.cell(row=56, column=14, value=0)

        try:
            sumr.cell(row=78, column=3,
                      value=pt[sumr.cell(row=13, column=3).value])
        except Exception as e:
            sumr.cell(row=78, column=3, value=0)
        try:
            sumr.cell(row=78, column=4,
                      value=pt[sumr.cell(row=13, column=4).value])
        except Exception as e:
            sumr.cell(row=78, column=4, value=0)
        try:
            sumr.cell(row=78, column=5,
                      value=pt[sumr.cell(row=13, column=5).value])
        except Exception as e:
            sumr.cell(row=78, column=5, value=0)
        try:
            sumr.cell(row=78, column=6,
                      value=pt[sumr.cell(row=13, column=6).value])
        except Exception as e:
            sumr.cell(row=78, column=6, value=0)
        try:
            sumr.cell(row=78, column=7,
                      value=pt[sumr.cell(row=13, column=7).value])
        except Exception as e:
            sumr.cell(row=78, column=7, value=0)
        try:
            sumr.cell(row=78, column=8,
                      value=pt[sumr.cell(row=13, column=8).value])
        except Exception as e:
            sumr.cell(row=78, column=8, value=0)
        try:
            sumr.cell(row=78, column=9,
                      value=pt[sumr.cell(row=13, column=9).value])
        except Exception as e:
            sumr.cell(row=78, column=9, value=0)
        try:
            sumr.cell(row=78, column=10,
                      value=pt[sumr.cell(row=13, column=10).value])
        except Exception as e:
            sumr.cell(row=78, column=10, value=0)
        try:
            sumr.cell(row=78, column=11,
                      value=pt[sumr.cell(row=13, column=11).value])
        except Exception as e:
            sumr.cell(row=78, column=11, value=0)
        try:
            sumr.cell(row=78, column=12,
                      value=pt[sumr.cell(row=13, column=12).value])
        except Exception as e:
            sumr.cell(row=78, column=12, value=0)
        try:
            sumr.cell(row=78, column=13,
                      value=pt[sumr.cell(row=13, column=13).value])
        except Exception as e:
            sumr.cell(row=78, column=13, value=0)
        try:
            sumr.cell(row=78, column=14,
                      value=pt[sumr.cell(row=13, column=14).value])
        except Exception as e:
            sumr.cell(row=78, column=14, value=0)

    try:
        sumr.cell(row=53, column=3,
                  value=FoodExpence[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=53, column=3, value=0)
    try:
        sumr.cell(row=53, column=4,
                  value=FoodExpence[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=53, column=4, value=0)
    try:
        sumr.cell(row=53, column=5,
                  value=FoodExpence[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=53, column=5, value=0)
    try:
        sumr.cell(row=53, column=6,
                  value=FoodExpence[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=53, column=6, value=0)
    try:
        sumr.cell(row=53, column=7,
                  value=FoodExpence[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=53, column=7, value=0)
    try:
        sumr.cell(row=53, column=8,
                  value=FoodExpence[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=53, column=8, value=0)
    try:
        sumr.cell(row=53, column=9,
                  value=FoodExpence[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=53, column=9, value=0)
    try:
        sumr.cell(row=53, column=10,
                  value=FoodExpence[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=53, column=10, value=0)
    try:
        sumr.cell(row=53, column=11,
                  value=FoodExpence[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=53, column=11, value=0)
    try:
        sumr.cell(row=53, column=12,
                  value=FoodExpence[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=53, column=12, value=0)
    try:
        sumr.cell(row=53, column=13,
                  value=FoodExpence[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=53, column=13, value=0)
    try:
        sumr.cell(row=53, column=14,
                  value=FoodExpence[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=53, column=14, value=0)

    try:
        sumr.cell(row=54, column=3,
                  value=CreditCharges[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=54, column=3, value=0)
    try:
        sumr.cell(row=54, column=4,
                  value=CreditCharges[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=54, column=4, value=0)
    try:
        sumr.cell(row=54, column=5,
                  value=CreditCharges[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=54, column=5, value=0)
    try:
        sumr.cell(row=54, column=6,
                  value=CreditCharges[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=54, column=6, value=0)
    try:
        sumr.cell(row=54, column=7,
                  value=CreditCharges[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=54, column=7, value=0)
    try:
        sumr.cell(row=54, column=8,
                  value=CreditCharges[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=54, column=8, value=0)
    try:
        sumr.cell(row=54, column=9,
                  value=CreditCharges[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=54, column=9, value=0)
    try:
        sumr.cell(row=54, column=10,
                  value=CreditCharges[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=54, column=10, value=0)
    try:
        sumr.cell(row=54, column=11,
                  value=CreditCharges[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=54, column=11, value=0)
    try:
        sumr.cell(row=54, column=12,
                  value=CreditCharges[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=54, column=12, value=0)
    try:
        sumr.cell(row=54, column=13,
                  value=CreditCharges[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=54, column=13, value=0)
    try:
        sumr.cell(row=54, column=14,
                  value=CreditCharges[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=54, column=14, value=0)

    try:
        sumr.cell(row=55, column=3,
                  value=OnlineShopping[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=55, column=3, value=0)
    try:
        sumr.cell(row=55, column=4,
                  value=OnlineShopping[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=55, column=4, value=0)
    try:
        sumr.cell(row=55, column=5,
                  value=OnlineShopping[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=55, column=5, value=0)
    try:
        sumr.cell(row=55, column=6,
                  value=OnlineShopping[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=55, column=6, value=0)
    try:
        sumr.cell(row=55, column=7,
                  value=OnlineShopping[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=55, column=7, value=0)
    try:
        sumr.cell(row=55, column=8,
                  value=OnlineShopping[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=55, column=8, value=0)
    try:
        sumr.cell(row=55, column=9,
                  value=OnlineShopping[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=55, column=9, value=0)
    try:
        sumr.cell(row=55, column=10,
                  value=OnlineShopping[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=55, column=10, value=0)
    try:
        sumr.cell(row=55, column=11,
                  value=OnlineShopping[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=55, column=11, value=0)
    try:
        sumr.cell(row=55, column=12,
                  value=OnlineShopping[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=55, column=12, value=0)
    try:
        sumr.cell(row=55, column=13,
                  value=OnlineShopping[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=55, column=13, value=0)
    try:
        sumr.cell(row=55, column=14,
                  value=OnlineShopping[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=55, column=14, value=0)

    try:
        sumr.cell(row=57, column=3,
                  value=GasPayment[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=57, column=3, value=0)
    try:
        sumr.cell(row=57, column=4,
                  value=GasPayment[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=57, column=4, value=0)
    try:
        sumr.cell(row=57, column=5,
                  value=GasPayment[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=57, column=5, value=0)
    try:
        sumr.cell(row=57, column=6,
                  value=GasPayment[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=57, column=6, value=0)
    try:
        sumr.cell(row=57, column=7,
                  value=GasPayment[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=57, column=7, value=0)
    try:
        sumr.cell(row=57, column=8,
                  value=GasPayment[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=57, column=8, value=0)
    try:
        sumr.cell(row=57, column=9,
                  value=GasPayment[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=57, column=9, value=0)
    try:
        sumr.cell(row=57, column=10,
                  value=GasPayment[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=57, column=10, value=0)
    try:
        sumr.cell(row=57, column=11,
                  value=GasPayment[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=57, column=11, value=0)
    try:
        sumr.cell(row=57, column=12,
                  value=GasPayment[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=57, column=12, value=0)
    try:
        sumr.cell(row=57, column=13,
                  value=GasPayment[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=57, column=13, value=0)
    try:
        sumr.cell(row=57, column=14,
                  value=GasPayment[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=57, column=14, value=0)

    try:
        sumr.cell(row=58, column=3,
                  value=GoldLoan[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=58, column=3, value=0)
    try:
        sumr.cell(row=58, column=4,
                  value=GoldLoan[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=58, column=4, value=0)
    try:
        sumr.cell(row=58, column=5,
                  value=GoldLoan[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=58, column=5, value=0)
    try:
        sumr.cell(row=58, column=6,
                  value=GoldLoan[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=58, column=6, value=0)
    try:
        sumr.cell(row=58, column=7,
                  value=GoldLoan[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=58, column=7, value=0)
    try:
        sumr.cell(row=58, column=8,
                  value=GoldLoan[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=58, column=8, value=0)
    try:
        sumr.cell(row=58, column=9,
                  value=GoldLoan[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=58, column=9, value=0)
    try:
        sumr.cell(row=58, column=10,
                  value=GoldLoan[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=58, column=10, value=0)
    try:
        sumr.cell(row=58, column=11,
                  value=GoldLoan[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=58, column=11, value=0)
    try:
        sumr.cell(row=58, column=12,
                  value=GoldLoan[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=58, column=12, value=0)
    try:
        sumr.cell(row=58, column=13,
                  value=GoldLoan[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=58, column=13, value=0)
    try:
        sumr.cell(row=58, column=14,
                  value=GoldLoan[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=58, column=14, value=0)

    try:
        sumr.cell(row=59, column=3,
                  value=rent_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=59, column=3, value=0)
    try:
        sumr.cell(row=59, column=4,
                  value=rent_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=59, column=4, value=0)
    try:
        sumr.cell(row=59, column=5,
                  value=rent_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=59, column=5, value=0)
    try:
        sumr.cell(row=59, column=6,
                  value=rent_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=59, column=6, value=0)
    try:
        sumr.cell(row=59, column=7,
                  value=rent_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=59, column=7, value=0)
    try:
        sumr.cell(row=59, column=8,
                  value=rent_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=59, column=8, value=0)
    try:
        sumr.cell(row=59, column=9,
                  value=rent_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=59, column=9, value=0)
    try:
        sumr.cell(row=59, column=10,
                  value=rent_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=59, column=10, value=0)
    try:
        sumr.cell(row=59, column=11,
                  value=rent_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=59, column=11, value=0)
    try:
        sumr.cell(row=59, column=12,
                  value=rent_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=59, column=12, value=0)
    try:
        sumr.cell(row=59, column=13,
                  value=rent_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=59, column=13, value=0)
    try:
        sumr.cell(row=59, column=14,
                  value=rent_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
...
def perExpenditure():
    ...
    # Bank charges
    df_charges = df1[df1["Particulars"].str.contains(
        "Consolidated Charges for A/c", na=False)]
    Bank_charges = df_charges.groupby(
        df_charges['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    # print(Bank_charges)
    ...
    # Emi
    new_emi = df1[df1['Particulars'].str.contains(
        'ECS') | df1['Particulars'].str.contains('NACH-DR')]
    Emi_dr = new_emi.groupby(new_emi['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()
    # print(new)
    ...
    # Food Expenses
    Food_Expenxe_df = df1[df1['Particulars'].str.contains(
        'Zomato') | df1['Particulars'].str.contains('Swiggy')]
    FoodExpence = Food_Expenxe_df.groupby(
        Food_Expenxe_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    # print(FoodExpence)
    ...
    tax_p = TaxPaid.groupby(TaxPaid['Tran Date'].dt.strftime(
        '%b-%Y'))['Debit'].sum().sort_values()

    #  medical expence
    medical_df = df1[df1["Particulars"].str.contains("Pharma") | df1["Particulars"].str.contains("hospital") | df1["Particulars"].str.contains(
        "clinic") | df1["Particulars"].str.contains("dentist") | df1["Particulars"].str.contains("PHARMA")]
    medical_charges = medical_df.groupby(
        medical_df['Tran Date'].dt.strftime('%b-%Y'))['Debit'].sum().sort_values()
    try:
        sumr.cell(row=64, column=3,
                  value=Bank_charges[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=64, column=3, value=0)
    try:
        sumr.cell(row=64, column=4,
                  value=Bank_charges[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=64, column=4, value=0)
    try:
        sumr.cell(row=64, column=5,
                  value=Bank_charges[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=64, column=5, value=0)
    try:
        sumr.cell(row=64, column=6,
                  value=Bank_charges[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=64, column=6, value=0)
    try:
        sumr.cell(row=64, column=7,
                  value=Bank_charges[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=64, column=7, value=0)
    try:
        sumr.cell(row=64, column=8,
                  value=Bank_charges[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=64, column=8, value=0)
    try:
        sumr.cell(row=64, column=9,
                  value=Bank_charges[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=64, column=9, value=0)
    try:
        sumr.cell(row=64, column=10,
                  value=Bank_charges[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=64, column=10, value=0)
    try:
        sumr.cell(row=64, column=11,
                  value=Bank_charges[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=64, column=11, value=0)
    try:
        sumr.cell(row=64, column=12,
                  value=Bank_charges[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=64, column=12, value=0)
    try:
        sumr.cell(row=64, column=13,
                  value=Bank_charges[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=64, column=13, value=0)
    try:
        sumr.cell(row=64, column=14,
                  value=Bank_charges[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=64, column=14, value=0)

    try:
        sumr.cell(row=65, column=3,
                  value=salary[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=65, column=3, value=0)
    try:
        sumr.cell(row=65, column=4,
                  value=salary[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=65, column=4, value=0)
    try:
        sumr.cell(row=65, column=5,
                  value=salary[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=65, column=5, value=0)
    try:
        sumr.cell(row=65, column=6,
                  value=salary[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=65, column=6, value=0)
    try:
        sumr.cell(row=65, column=7,
                  value=salary[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=65, column=7, value=0)
    try:
        sumr.cell(row=65, column=8,
                  value=salary[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=65, column=8, value=0)
    try:
        sumr.cell(row=65, column=9,
                  value=salary[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=65, column=9, value=0)
    try:
        sumr.cell(row=65, column=10,
                  value=salary[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=65, column=10, value=0)
    try:
        sumr.cell(row=65, column=11,
                  value=salary[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=65, column=11, value=0)
    try:
        sumr.cell(row=65, column=12,
                  value=salary[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=65, column=12, value=0)
    try:
        sumr.cell(row=65, column=13,
                  value=salary[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=65, column=13, value=0)
    try:
        sumr.cell(row=65, column=14,
                  value=salary[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=65, column=14, value=0)

    try:
        sumr.cell(row=66, column=3,
                  value=Bank_charges[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=66, column=3, value=0)
    try:
        sumr.cell(row=66, column=4,
                  value=Bank_charges[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=66, column=4, value=0)
    try:
        sumr.cell(row=66, column=5,
                  value=Bank_charges[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=66, column=5, value=0)
    try:
        sumr.cell(row=66, column=6,
                  value=Bank_charges[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=66, column=6, value=0)
    try:
        sumr.cell(row=66, column=7,
                  value=Bank_charges[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=66, column=7, value=0)
    try:
        sumr.cell(row=66, column=8,
                  value=Bank_charges[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=66, column=8, value=0)
    try:
        sumr.cell(row=66, column=9,
                  value=Bank_charges[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=66, column=9, value=0)
    try:
        sumr.cell(row=66, column=10,
                  value=Bank_charges[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=66, column=10, value=0)
    try:
        sumr.cell(row=66, column=11,
                  value=Bank_charges[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=66, column=11, value=0)
    try:
        sumr.cell(row=66, column=12,
                  value=Bank_charges[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=66, column=12, value=0)
    try:
        sumr.cell(row=66, column=13,
                  value=Bank_charges[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=66, column=13, value=0)
    try:
        sumr.cell(row=66, column=14,
                  value=Bank_charges[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=66, column=14, value=0)

    try:
        sumr.cell(row=67, column=3,
                  value=Emi_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=67, column=3, value=0)
    try:
        sumr.cell(row=67, column=4,
                  value=Emi_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=67, column=4, value=0)
    try:
        sumr.cell(row=67, column=5,
                  value=Emi_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=67, column=5, value=0)
    try:
        sumr.cell(row=67, column=6,
                  value=Emi_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=67, column=6, value=0)
    try:
        sumr.cell(row=67, column=7,
                  value=Emi_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=67, column=7, value=0)
    try:
        sumr.cell(row=67, column=8,
                  value=Emi_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=67, column=8, value=0)
    try:
        sumr.cell(row=67, column=9,
                  value=Emi_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=67, column=9, value=0)
    try:
        sumr.cell(row=67, column=10,
                  value=Emi_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=67, column=10, value=0)
    try:
        sumr.cell(row=67, column=11,
                  value=Emi_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=67, column=11, value=0)
    try:
        sumr.cell(row=67, column=12,
                  value=Emi_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=67, column=12, value=0)
    try:
        sumr.cell(row=67, column=13,
                  value=Emi_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=67, column=13, value=0)
    try:
        sumr.cell(row=67, column=14,
                  value=Emi_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=67, column=14, value=0)

    try:
        sumr.cell(row=69, column=3,
                  value=gst[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=69, column=3, value=0)
    try:
        sumr.cell(row=69, column=4,
                  value=gst[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=69, column=4, value=0)
    try:
        sumr.cell(row=69, column=5,
                  value=gst[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=69, column=5, value=0)
    try:
        sumr.cell(row=69, column=6,
                  value=gst[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=69, column=6, value=0)
    try:
        sumr.cell(row=69, column=7,
                  value=gst[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=69, column=7, value=0)
    try:
        sumr.cell(row=69, column=8,
                  value=gst[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=69, column=8, value=0)
    try:
        sumr.cell(row=69, column=9,
                  value=gst[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=69, column=9, value=0)
    try:
        sumr.cell(row=69, column=10,
                  value=gst[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=69, column=10, value=0)
    try:
        sumr.cell(row=69, column=11,
                  value=gst[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=69, column=11, value=0)
    try:
        sumr.cell(row=69, column=12,
                  value=gst[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=69, column=12, value=0)
    try:
        sumr.cell(row=69, column=13,
                  value=gst[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=69, column=13, value=0)
    try:
        sumr.cell(row=69, column=14,
                  value=gst[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=69, column=14, value=0)

    try:
        sumr.cell(row=70, column=3,
                  value=tax_p[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=70, column=3, value=0)
    try:
        sumr.cell(row=70, column=4,
                  value=tax_p[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=70, column=4, value=0)
    try:
        sumr.cell(row=70, column=5,
                  value=tax_p[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=70, column=5, value=0)
    try:
        sumr.cell(row=70, column=6,
                  value=tax_p[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=70, column=6, value=0)
    try:
        sumr.cell(row=70, column=7,
                  value=tax_p[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=70, column=7, value=0)
    try:
        sumr.cell(row=70, column=8,
                  value=tax_p[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=70, column=8, value=0)
    try:
        sumr.cell(row=70, column=9,
                  value=tax_p[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=70, column=9, value=0)
    try:
        sumr.cell(row=70, column=10,
                  value=tax_p[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=70, column=10, value=0)
    try:
        sumr.cell(row=70, column=11,
                  value=tax_p[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=70, column=11, value=0)
    try:
        sumr.cell(row=70, column=12,
                  value=tax_p[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=70, column=12, value=0)
    try:
        sumr.cell(row=70, column=13,
                  value=tax_p[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=70, column=13, value=0)
    try:
        sumr.cell(row=70, column=14,
                  value=tax_p[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=70, column=14, value=0)

    try:
        sumr.cell(row=71, column=3,
                  value=Utility[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=71, column=3, value=0)
    try:
        sumr.cell(row=71, column=4,
                  value=Utility[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=71, column=4, value=0)
    try:
        sumr.cell(row=71, column=5,
                  value=Utility[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=71, column=5, value=0)
    try:
        sumr.cell(row=71, column=6,
                  value=Utility[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=71, column=6, value=0)
    try:
        sumr.cell(row=71, column=7,
                  value=Utility[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=71, column=7, value=0)
    try:
        sumr.cell(row=71, column=8,
                  value=Utility[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=71, column=8, value=0)
    try:
        sumr.cell(row=71, column=9,
                  value=Utility[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=71, column=9, value=0)
    try:
        sumr.cell(row=71, column=10,
                  value=Utility[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=71, column=10, value=0)
    try:
        sumr.cell(row=71, column=11,
                  value=Utility[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=71, column=11, value=0)
    try:
        sumr.cell(row=71, column=12,
                  value=Utility[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=71, column=12, value=0)
    try:
        sumr.cell(row=71, column=13,
                  value=Utility[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=71, column=13, value=0)
    try:
        sumr.cell(row=71, column=14,
                  value=Utility[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=71, column=14, value=0)

    try:
        sumr.cell(row=45, column=3,
                  value=Utility[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=45, column=3, value=0)
    try:
        sumr.cell(row=45, column=4,
                  value=Utility[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=45, column=4, value=0)
    try:
        sumr.cell(row=45, column=5,
                  value=Utility[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=45, column=5, value=0)
    try:
        sumr.cell(row=45, column=6,
                  value=Utility[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=45, column=6, value=0)
    try:
        sumr.cell(row=45, column=7,
                  value=Utility[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=45, column=7, value=0)
    try:
        sumr.cell(row=45, column=8,
                  value=Utility[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=45, column=8, value=0)
    try:
        sumr.cell(row=45, column=9,
                  value=Utility[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=45, column=9, value=0)
    try:
        sumr.cell(row=45, column=10,
                  value=Utility[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=45, column=10, value=0)
    try:
        sumr.cell(row=45, column=11,
                  value=Utility[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=45, column=11, value=0)
    try:
        sumr.cell(row=45, column=12,
                  value=Utility[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=45, column=12, value=0)
    try:
        sumr.cell(row=45, column=13,
                  value=Utility[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=45, column=13, value=0)
    try:
        sumr.cell(row=45, column=14,
                  value=Utility[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=45, column=14, value=0)

    try:
        sumr.cell(row=73, column=3,
                  value=GeneralInsurance[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=73, column=3, value=0)
    try:
        sumr.cell(row=73, column=4,
                  value=GeneralInsurance[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=73, column=4, value=0)
    try:
        sumr.cell(row=73, column=5,
                  value=GeneralInsurance[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=73, column=5, value=0)
    try:
        sumr.cell(row=73, column=6,
                  value=GeneralInsurance[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=73, column=6, value=0)
    try:
        sumr.cell(row=73, column=7,
                  value=GeneralInsurance[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=73, column=7, value=0)
    try:
        sumr.cell(row=73, column=8,
                  value=GeneralInsurance[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=73, column=8, value=0)
    try:
        sumr.cell(row=73, column=9,
                  value=GeneralInsurance[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=73, column=9, value=0)
    try:
        sumr.cell(row=73, column=10,
                  value=GeneralInsurance[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=73, column=10, value=0)
    try:
        sumr.cell(row=73, column=11,
                  value=GeneralInsurance[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=73, column=11, value=0)
    try:
        sumr.cell(row=73, column=12,
                  value=GeneralInsurance[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=73, column=12, value=0)
    try:
        sumr.cell(row=73, column=13,
                  value=GeneralInsurance[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=73, column=13, value=0)
    try:
        sumr.cell(row=73, column=14,
                  value=GeneralInsurance[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=73, column=14, value=0)

    try:
        sumr.cell(row=74, column=3,
                  value=LifeInsurance[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=74, column=3, value=0)
    try:
        sumr.cell(row=74, column=4,
                  value=LifeInsurance[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=74, column=4, value=0)
    try:
        sumr.cell(row=74, column=5,
                  value=LifeInsurance[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=74, column=5, value=0)
    try:
        sumr.cell(row=74, column=6,
                  value=LifeInsurance[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=74, column=6, value=0)
    try:
        sumr.cell(row=74, column=7,
                  value=LifeInsurance[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=74, column=7, value=0)
    try:
        sumr.cell(row=74, column=8,
                  value=LifeInsurance[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=74, column=8, value=0)
    try:
        sumr.cell(row=74, column=9,
                  value=LifeInsurance[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=74, column=9, value=0)
    try:
        sumr.cell(row=74, column=10,
                  value=LifeInsurance[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=74, column=10, value=0)
    try:
        sumr.cell(row=74, column=11,
                  value=LifeInsurance[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=74, column=11, value=0)
    try:
        sumr.cell(row=74, column=12,
                  value=LifeInsurance[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=74, column=12, value=0)
    try:
        sumr.cell(row=74, column=13,
                  value=LifeInsurance[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=74, column=13, value=0)
    try:
        sumr.cell(row=74, column=14,
                  value=LifeInsurance[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=74, column=14, value=0)

    try:
        sumr.cell(row=75, column=3,
                  value=FoodExpence[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=75, column=3, value=0)
    try:
        sumr.cell(row=75, column=4,
                  value=FoodExpence[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=75, column=4, value=0)
    try:
        sumr.cell(row=75, column=5,
                  value=FoodExpence[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=75, column=5, value=0)
    try:
        sumr.cell(row=75, column=6,
                  value=FoodExpence[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=75, column=6, value=0)
    try:
        sumr.cell(row=75, column=7,
                  value=FoodExpence[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=75, column=7, value=0)
    try:
        sumr.cell(row=75, column=8,
                  value=FoodExpence[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=75, column=8, value=0)
    try:
        sumr.cell(row=75, column=9,
                  value=FoodExpence[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=75, column=9, value=0)
    try:
        sumr.cell(row=75, column=10,
                  value=FoodExpence[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=75, column=10, value=0)
    try:
        sumr.cell(row=75, column=11,
                  value=FoodExpence[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=75, column=11, value=0)
    try:
        sumr.cell(row=75, column=12,
                  value=FoodExpence[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=75, column=12, value=0)
    try:
        sumr.cell(row=75, column=13,
                  value=FoodExpence[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=75, column=13, value=0)
    try:
        sumr.cell(row=75, column=14,
                  value=FoodExpence[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=75, column=14, value=0)

    try:
        sumr.cell(row=77, column=3,
                  value=OnlineShopping[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=77, column=3, value=0)
    try:
        sumr.cell(row=77, column=4,
                  value=OnlineShopping[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=77, column=4, value=0)
    try:
        sumr.cell(row=77, column=5,
                  value=OnlineShopping[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=77, column=5, value=0)
    try:
        sumr.cell(row=77, column=6,
                  value=OnlineShopping[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=77, column=6, value=0)
    try:
        sumr.cell(row=77, column=7,
                  value=OnlineShopping[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=77, column=7, value=0)
    try:
        sumr.cell(row=77, column=8,
                  value=OnlineShopping[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=77, column=8, value=0)
    try:
        sumr.cell(row=77, column=9,
                  value=OnlineShopping[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=77, column=9, value=0)
    try:
        sumr.cell(row=77, column=10,
                  value=OnlineShopping[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=77, column=10, value=0)
    try:
        sumr.cell(row=77, column=11,
                  value=OnlineShopping[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=77, column=11, value=0)
    try:
        sumr.cell(row=77, column=12,
                  value=OnlineShopping[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=77, column=12, value=0)
    try:
        sumr.cell(row=77, column=13,
                  value=OnlineShopping[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=77, column=13, value=0)
    try:
        sumr.cell(row=77, column=14,
                  value=OnlineShopping[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=77, column=14, value=0)

    try:
        sumr.cell(row=79, column=3,
                  value=GasPayment[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=79, column=3, value=0)
    try:
        sumr.cell(row=79, column=4,
                  value=GasPayment[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=79, column=4, value=0)
    try:
        sumr.cell(row=79, column=5,
                  value=GasPayment[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=79, column=5, value=0)
    try:
        sumr.cell(row=79, column=6,
                  value=GasPayment[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=79, column=6, value=0)
    try:
        sumr.cell(row=79, column=7,
                  value=GasPayment[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=79, column=7, value=0)
    try:
        sumr.cell(row=79, column=8,
                  value=GasPayment[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=79, column=8, value=0)
    try:
        sumr.cell(row=79, column=9,
                  value=GasPayment[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=79, column=9, value=0)
    try:
        sumr.cell(row=79, column=10,
                  value=GasPayment[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=79, column=10, value=0)
    try:
        sumr.cell(row=79, column=11,
                  value=GasPayment[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=79, column=11, value=0)
    try:
        sumr.cell(row=79, column=12,
                  value=GasPayment[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=79, column=12, value=0)
    try:
        sumr.cell(row=79, column=13,
                  value=GasPayment[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=79, column=13, value=0)
    try:
        sumr.cell(row=79, column=14,
                  value=GasPayment[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=79, column=14, value=0)

    try:
        sumr.cell(row=80, column=3,
                  value=GoldLoan[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=80, column=3, value=0)
    try:
        sumr.cell(row=80, column=4,
                  value=GoldLoan[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=80, column=4, value=0)
    try:
        sumr.cell(row=80, column=5,
                  value=GoldLoan[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=80, column=5, value=0)
    try:
        sumr.cell(row=80, column=6,
                  value=GoldLoan[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=80, column=6, value=0)
    try:
        sumr.cell(row=80, column=7,
                  value=GoldLoan[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=80, column=7, value=0)
    try:
        sumr.cell(row=80, column=8,
                  value=GoldLoan[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=80, column=8, value=0)
    try:
        sumr.cell(row=80, column=9,
                  value=GoldLoan[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=80, column=9, value=0)
    try:
        sumr.cell(row=80, column=10,
                  value=GoldLoan[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=80, column=10, value=0)
    try:
        sumr.cell(row=80, column=11,
                  value=GoldLoan[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=80, column=11, value=0)
    try:
        sumr.cell(row=80, column=12,
                  value=GoldLoan[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=80, column=12, value=0)
    try:
        sumr.cell(row=80, column=13,
                  value=GoldLoan[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=80, column=13, value=0)
    try:
        sumr.cell(row=80, column=14,
                  value=GoldLoan[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=80, column=14, value=0)

    try:
        sumr.cell(row=81, column=3,
                  value=rent_dr[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=81, column=3, value=0)
    try:
        sumr.cell(row=81, column=4,
                  value=rent_dr[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=81, column=4, value=0)
    try:
        sumr.cell(row=81, column=5,
                  value=rent_dr[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=81, column=5, value=0)
    try:
        sumr.cell(row=81, column=6,
                  value=rent_dr[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=81, column=6, value=0)
    try:
        sumr.cell(row=81, column=7,
                  value=rent_dr[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=81, column=7, value=0)
    try:
        sumr.cell(row=81, column=8,
                  value=rent_dr[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=81, column=8, value=0)
    try:
        sumr.cell(row=81, column=9,
                  value=rent_dr[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=81, column=9, value=0)
    try:
        sumr.cell(row=81, column=10,
                  value=rent_dr[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=81, column=10, value=0)
    try:
        sumr.cell(row=81, column=11,
                  value=rent_dr[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=81, column=11, value=0)
    try:
        sumr.cell(row=81, column=12,
                  value=rent_dr[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=81, column=12, value=0)
    try:
        sumr.cell(row=81, column=13,
                  value=rent_dr[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=81, column=13, value=0)
    try:
        sumr.cell(row=81, column=14,
                  value=rent_dr[sumr.cell(row=13, column=14).value])
    except Exception as e:
        sumr.cell(row=81, column=14, value=0)

    try:
        sumr.cell(row=82, column=3,
                  value=medical_charges[sumr.cell(row=13, column=3).value])
    except Exception as e:
        sumr.cell(row=82, column=3, value=0)
    try:
        sumr.cell(row=82, column=4,
                  value=medical_charges[sumr.cell(row=13, column=4).value])
    except Exception as e:
        sumr.cell(row=82, column=4, value=0)
    try:
        sumr.cell(row=82, column=5,
                  value=medical_charges[sumr.cell(row=13, column=5).value])
    except Exception as e:
        sumr.cell(row=82, column=5, value=0)
    try:
        sumr.cell(row=82, column=6,
                  value=medical_charges[sumr.cell(row=13, column=6).value])
    except Exception as e:
        sumr.cell(row=82, column=6, value=0)
    try:
        sumr.cell(row=82, column=7,
                  value=medical_charges[sumr.cell(row=13, column=7).value])
    except Exception as e:
        sumr.cell(row=82, column=7, value=0)
    try:
        sumr.cell(row=82, column=8,
                  value=medical_charges[sumr.cell(row=13, column=8).value])
    except Exception as e:
        sumr.cell(row=82, column=8, value=0)
    try:
        sumr.cell(row=82, column=9,
                  value=medical_charges[sumr.cell(row=13, column=9).value])
    except Exception as e:
        sumr.cell(row=82, column=9, value=0)
    try:
        sumr.cell(row=82, column=10,
                  value=medical_charges[sumr.cell(row=13, column=10).value])
    except Exception as e:
        sumr.cell(row=82, column=10, value=0)
    try:
        sumr.cell(row=82, column=11,
                  value=medical_charges[sumr.cell(row=13, column=11).value])
    except Exception as e:
        sumr.cell(row=82, column=11, value=0)
    try:
        sumr.cell(row=82, column=12,
                  value=medical_charges[sumr.cell(row=13, column=12).value])
    except Exception as e:
        sumr.cell(row=82, column=12, value=0)
    try:
        sumr.cell(row=82, column=13,
                  value=medical_charges[sumr.cell(row=13, column=13).value])
    except Exception as e:
        sumr.cell(row=82, column=13, value=0)
    try:
        sumr.cell(row=82, column=14,
                  value=medical_charges[sumr.cell(row=13, column=14).value])
    except Exception as e:
...
# Load the Excel file
df = pd.read_excel('Excel_Files/Dashboard/BankStatement.xlsx',
                   sheet_name='Transaction1')
