        ...
        for i in range(num_pages):
            ...
            if i == 0:
                try:
                    z = i+1
                    z = str(z)
                    tables = camelot.read_pdf(self.file_name, password=self.passwd, flavor='stream', pages=z, table_regions=[
                                              '0,900,800,60'], row_tol=10)
                    c = tables[0].df
...
# enddate='31/03/2021'
# BOB('BOB bank statement.pdf',passwd,startdate,enddate)
